...
export const SETTINGS = [
  {
    ...
    optionLabels: {
      ...
      grimoire: 'settings:themeOptions.grimoire',
      lofi: 'settings:themeOptions.lofi',
      botanical: 'settings:themeOptions.botanical',
      noir: 'settings:themeOptions.noir',
      celestial: 'settings:themeOptions.celestial',
      'amber-wasteland': 'settings:themeOptions.amberWasteland',
      y2k: 'settings:themeOptions.y2k',
    },
  },
  {
    key: 'cardsPerPage',
  ...
  },
  {
    ...
    options: ['simple-roleplay', 'bracketed', 'chatml', 'mistral-instruct', 'metharme', 'custom'],
    optionLabels: {
      ...
      metharme: 'settings:prompting.hordeNative.options.metharme',
  ...
  // TTS settings — rendered by TtsSettingsPanel, not SettingRow
  {
    ...
    type: 'select',
    default: 'browser',
    options: ['browser', 'kitten-mini', 'kitten-micro', 'kitten-nano-fp32', 'kitten-nano-int8'],
    optionLabels: {
      browser: 'settings:tts.browser.title',
      'kitten-mini': 'settings:tts.kitten.models.mini.label',
      'kitten-micro': 'settings:tts.kitten.models.micro.label',
      'kitten-nano-fp32': 'settings:tts.kitten.models.nanoFp32.label',
      'kitten-nano-int8': 'settings:tts.kitten.models.nanoInt8.label',
    },
    labelKey: 'settings:tts.activeProvider.label',
    descKey: 'settings:tts.activeProvider.desc',
  },
  {
    key: 'tts.backend',
    category: 'tts',
    type: 'select',
    default: 'auto',
    options: ['auto', 'wasm', 'webgpu'],
    optionLabels: {
      auto: 'settings:tts.kitten.backend.auto',
      wasm: 'settings:tts.kitten.backend.wasm',
      webgpu: 'settings:tts.kitten.backend.webgpu',
    },
    labelKey: 'settings:tts.kitten.backend.label',
    descKey: 'settings:tts.kitten.backend.desc',
  },
  {
    key: 'tts.browserVoice',
    category: 'tts',
    type: 'text',
    default: '',
    labelKey: 'settings:tts.browser.voice.label',
    descKey: 'settings:tts.browser.voice.desc',
  },
  {
    key: 'tts.kittenVoice',
    category: 'tts',
    ...
    labelKey: 'settings:tts.kitten.voice.label',
    descKey: 'settings:tts.kitten.voice.desc',
  },
  {
    key: 'tts.browserRate',
    category: 'tts',
    type: 'slider',
    default: 1,
    props: { min: 0.5, max: 2, step: 0.1 },
    labelKey: 'settings:tts.browser.rate.label',
    descKey: 'settings:tts.browser.rate.desc',
  },
  {
    key: 'tts.browserPitch',
    category: 'tts',
    type: 'slider',
    default: 1,
    props: { min: 0.5, max: 1.5, step: 0.1 },
    labelKey: 'settings:tts.browser.pitch.label',
    descKey: 'settings:tts.browser.pitch.desc',
  },
  {
    key: 'tts.browserVolume',
    category: 'tts',
    type: 'slider',
    default: 1,
    props: { min: 0, max: 1, step: 0.05 },
    labelKey: 'settings:tts.browser.volume.label',
    descKey: 'settings:tts.browser.volume.desc',
  },
  {
    key: 'tts.kittenSpeed',
    category: 'tts',
    ...
    default: 1,
    props: { min: 0.5, max: 2, step: 0.1 },
    labelKey: 'settings:tts.kitten.speed.label',
    descKey: 'settings:tts.kitten.speed.desc',
  },
  {
