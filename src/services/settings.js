...
export const SETTINGS = [
  ...
  },
  {
    ...
    default: 'always',
    options: ['always'],
    labelKey: 'settings:prompting.writingInjectionTiming.label',
    descKey: 'settings:prompting.writingInjectionTiming.desc',
    optionLabels: {
      always: 'settings:prompting.writingInjectionTimingOptions.always',
    },
  },
  {
    ...
    labelKey: 'settings:prompting.writingPlacement.label',
    descKey: 'settings:prompting.writingPlacement.desc',
    optionLabels: {
      endOfSystemPrompt: 'settings:prompting.writingPlacementOptions.endOfSystemPrompt',
      endOfMessages: 'settings:prompting.writingPlacementOptions.endOfMessages',
    },
  },
  {
    ...
    labelKey: 'settings:prompting.writingMessageRole.label',
    descKey: 'settings:prompting.writingMessageRole.desc',
    optionLabels: {
      system: 'settings:prompting.writingMessageRoleOptions.system',
      assistant: 'settings:prompting.writingMessageRoleOptions.assistant',
    },
  },
  {
