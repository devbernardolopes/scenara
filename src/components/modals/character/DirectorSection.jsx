...
const GROUPS = [
  ...
  {
    id: 'regularChatStatusBlock',
    labelKey: 'directorGroupRegularChatStatusBlock',
    enabledKey: 'directorRegularChatStatusBlockEnabled',
    instructionsKey: 'directorRegularChatStatusBlockInstructions',
    instructionsLabelKey: 'directorRegularChatStatusBlockInstructions',
    placeholderKey: 'directorRegularChatStatusBlockInstructionsPlaceholder',
    storageBase: 'charSection.directorRegularChatStatusBlock',
    systemInstructionsKey: 'directorRegularChatStatusBlockSystemInstructions',
    systemInstructionsLabelKey: 'directorRegularChatStatusBlockSystemInstructions',
    systemInstructionsPlaceholderKey: 'directorRegularChatStatusBlockSystemInstructionsPlaceholder',
    systemStorageBase: 'charSection.directorRegularChatStatusBlockSystem',
  },
  {
    id: 'ooc',
