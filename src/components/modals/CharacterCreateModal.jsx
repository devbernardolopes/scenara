...
const INITIAL_FORM = {
  ...
  includeOOC: true,
  removeCodeBlocksFromStatusBlock: true,
...
const DEFAULTS_MAP = {
  ...
  defaultMessageRollover: 'messageRollover',
  ...
  defaultRemoveCodeBlocksFromStatusBlock: 'removeCodeBlocksFromStatusBlock',
  defaultRemoveMarkdownImages: 'removeMarkdownImages',
  defaultPostProcessing: 'postProcessing',
  defaultInjectQuotes: 'injectQuotes',
...
const OVERRIDE_FIELDS = [
  ...
  'userPersonaPrefix',
  'includeOOC',
  'removeCodeBlocksFromStatusBlock',
    ...
    <div className="flex flex-col min-h-0 flex-1">
      ...
      <div className="px-6 pt-4 pb-2 shrink-0 md:hidden">
        <select
          ...
          className="w-full px-3 py-2 min-h-[44px] border border-border rounded-md bg-surface bg-surface-secondary text-text text-sm"
        >
          {[
      ...
      <div className="flex items-center justify-between gap-3 px-6 py-4 shadow-section shrink-0">
